...
export default function JoinViaLinkCard({ onClick }) {
  return (
    <div className="flex-1 bg-white dark:bg-gray-950 border-2 border-gray-100 hover:border-purple-600 dark:border-gray-800 rounded-[24px] p-8 flex flex-col items-center text-center shadow-[0_8px_30px_rgba(0,0,0,0.04)] transition-all hover:shadow-md hover:translate-y-[-4px]">
      ...
      <p className="text-gray-500 dark:text-gray-400 text-sm mb-8 max-w-[220px] leading-relaxed">
        Got an invite link? Join an existing session
      </p>
