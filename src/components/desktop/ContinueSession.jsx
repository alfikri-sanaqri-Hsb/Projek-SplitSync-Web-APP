...
export default function ContinueSession({ onSecondaryClick }) {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto mt-8">
      <div className="bg-blue-100 dark:bg-gray-950 border border-gray-100 dark:border-gray-800 rounded-[24px] p-6 flex flex-col md:flex-row items-center justify-between gap-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.07)] transition-shadow duration-300">
        <div className="flex items-center gap-5 w-full md:w-auto">
          ...
          <div className="flex-1">
            <h3 className="text-2xl font-split text-gray-950 dark:text-white leading-tight">
