export default function QrisModal({
  ...
  return (
    ...
    <div
      ...
      <div
        className="relative w-full max-w-md bg-white dark:bg-gray-900 rounded-3xl shadow-2xl p-6 mx-auto">
        ...
        {qris ? (
          ...
          <div className="flex justify-center items-center">
            ...
            <div
              className="bg-white p-4 rounded-2xl border border-gray-200 dark:border-gray-700">
